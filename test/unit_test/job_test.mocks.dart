...
// in final_assignment/test/unit_test/job_test.dart.
...
class MockJobUseCase extends _i1.Mock implements _i3.JobUseCase {
  @override
  _i4.Future<_i2.Either<_i5.Failure, List<_i6.JobEntity>>> getAllJobs(
          int? page) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAllJobs,
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, bool>> applyToJob(
    String? jobId,
    String? resumeId,
  ) =>
      (super.noSuchMethod(
